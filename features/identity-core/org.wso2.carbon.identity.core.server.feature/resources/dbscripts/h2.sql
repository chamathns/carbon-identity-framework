...
CREATE TABLE IF NOT EXISTS IDN_FEATURE_MAPPING (
    ID INTEGER AUTO_INCREMENT,
	TENANT_ID INTEGER NOT NULL,
	USER_ID VARCHAR(255) NOT NULL,
	FEATURE_TYPE VARCHAR(255) NOT NULL,
	IS_FEATURE_LOCKED BOOLEAN(1) NOT NULL,
	FEATURE_UNLOCK_TIME INTEGER NOT NULL,
	FEATURE_LOCK_REASON VARCHAR(1023),
	FEATURE_LOCK_REASON_CODE VARCHAR(255),

    PRIMARY KEY (ID),
	CONSTRAINT IDN_FEATURE_MAPPING_CONSTRAINT UNIQUE (TENANT_ID, USER_ID, FEATURE_TYPE)
);
